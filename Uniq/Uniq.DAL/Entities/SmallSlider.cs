...
namespace Uniq.DAL.Entities
{
    public class SmallSlider
    {
        ...
        [StringLength(20), Column(TypeName = "varchar(20)"), Required(), Display(Name = "İlk Başlık Açıklama")]
        public string FirstDescription { get; set; }
        [StringLength(20), Column(TypeName = "varchar(20)"), Required(), Display(Name = "İkinci Başlık")]
        public string SecondTitle { get; set; }
        [StringLength(20), Column(TypeName = "varchar(20)"), Required(), Display(Name = "İkinci Başlık Açıklama")]
        public string SecondDescription { get; set; }
        [StringLength(20), Column(TypeName = "varchar(20)"), Required(), Display(Name = "Üçüncü Başlık")]
        public string ThirdTitle { get; set; }
        [StringLength(20), Column(TypeName = "varchar(20)"), Required(), Display(Name = "Üçüncü Başlık Açıklama")]
        ...
        [StringLength(20), Column(TypeName = "varchar(20)"), Required(), Display(Name = "Dördüncü Başlık Açıklama")]
